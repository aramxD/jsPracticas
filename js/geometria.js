...
function calculoGeometrico() {
    ...
    area = areaDeCuadrado(input)
    console.log(area)

    let resultadoArea = document.getElementById('resultadoArea')
    resultadoArea.innerText = area

    //Aqui se imprime el area 
    let resultadoPerimetro = document.getElementById('resultadoPerimetro')
    resultadoPerimetro.innerText = perimetro
        //Cambiar el hidden
    document.getElementById('outputGeometria').classList.remove('hidden')
